...
func TestSMSLogColumnsMatchDefaultCSVHeader(t *testing.T) {
	want := "received_at,message_id,client,to,from,segments,total_charged,currency,carrier,failover_sequence,status,carrier_message_id,client_ref,egress_a_number,egress_b_number"
	var heads []string
